  ...
  var t = {
        ...
        ;(g && x) ||
          ...
          b
            ...
            : c.addEventListener &&
              ...
              'file:' !== n.protocol &&
              !v(M)
            ? ((o = M), c.addEventListener('message', _, !1))
            : (o =
                L in d('script')
                  ? function (t) {
      ...
      5112: (t, r, e) => {
        ...
        t.exports = function (t) {
          if (!i(s, t) || (!c && 'string' != typeof s[t])) {
            var r = 'Symbol.' + t
            c && i(f, t) ? (s[t] = f[t]) : (s[t] = u && p ? p(r) : v(r))
          }
          return s[t]
        }
      },
      9191: (t, r, e) => {
        ...
        t.exports = function (t, r, e, m) {
          ...
          if (w) {
            var j = w.prototype
            if ((!y && o(j, 'cause') && delete j.cause, !e)) return w
            var O = n('Error'),
              E = r(function (t, r) {
            ...
            if (
              ...
              'Error' !== S
                ? c
                  ? c(E, O)
                  : u(E, O, { name: !0 })
                : d && b in w && (s(E, w, b), s(E, w, 'prepareStackTrace')),
              u(E, w),
              !y)
            )
              try {
                j.name !== S && i(j, 'name', S), (j.constructor = E)
              } catch (t) {}
            return E
          }
        }
          ...
          T = function (t, r) {
            ...
            if ((p(r) || void 0 !== t) && !v(t))
              return (
                s(r) ||
                  (r = function (t, r) {
                    if ((f(n) && (r = a(n, this, t, r)), !v(r))) return r
                  }),
                (e[1] = r),
                i(d, null, e)
              )
          ...
          n(
            { target: 'JSON', stat: !0, arity: 3, forced: O || E },
            {
              stringify: function (t, r, e) {
                var n = l(arguments),
                  o = i(O ? T : d, null, n)
                return E && 'string' == typeof o ? g(o, S, P) : o
              },
            }
          )
      },
      ...
      3401: (t, r, e) => {
        ...
        var n,
          ...
          K = function (t, r, e) {
            ...
            z
              ...
              !_ && (o = s['on' + t])
                ? o(n)
                : t === H && w('Unhandled promise rejection', e)
          },
          $ = function (t) {
            f(x, s, function () {
              var r,
              ...
              if (
                X(t) &&
                ((r = j(function () {
                  u ? G.emit('unhandledRejection', n, e) : K(H, e, n)
                })),
        ...
        if (
          ...
          }).prototype = p(I, 'then', function (t, r) {
            var e = k(this),
              n = V(g(this, N))
            return (
              (e.parent = !0),
          ...
          (L.f = V =
            function (t) {
              return t === N || undefined === t ? new o(t) : q(t)
            }),
          !c && y(T) && F !== Object.prototype)
        ) {
          ;(i = F.then),
            M ||
              p(
