    ...
    <div class="main mb-auto">
      ...
      >
        <div class="text-white text-center md:pt-10">
          ...
          >
            Partnering clinicians, industry, patients, and philanthropy to
            create better data for health.
          </div>
        </div>
      </div>
      ...
      <div class="px-16 bg-white">
        <h1
          tabindex="2"
          class="satoshi-black font-bold font-36px text-darkbrown"
        >
          Leadership
        </h1>
        <div
      ...
      <div class="px-16 pt-20 bg-white">
        ...
        <p tabindex="2" class="pt-2.5 w-full lg:w-3/4">
          ...
          <span class="underline"
            ...
            ></span
          >
          aims to improve cancer care and research by gathering health systems
          to develop best practices for implementing mCODE and use-case-based
          extensions into production EHRs and other systems. There is no cost
          for participation in the CoP's monthly calls.
        </p>
