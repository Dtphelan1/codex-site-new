<template>
  <div
    class="h-auto md:h-full px-8 pt-8 md:pt-28 lg:pt-48 pb-6 bg-darkgrey text-white flex flex-col justify-center md:flex-nowrap md:flex-row md:gap-8 lg:gap-16 xl:gap-32"
  >
    <div
